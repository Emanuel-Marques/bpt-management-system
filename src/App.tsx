    ...
    <>
        ...
        <div className="relative w-full h-3/4 bg-cover bg-center" style={{ backgroundImage: `url(${banner})` }}>
          ...
          <div className="relative z-10 p-4 text-white flex flex-col gap-10">
            ...
            <div className="w-1/2 mx-64">
              ...
              <button className="bg-blue-500 text-white px-4 py-2 mt-4">Saiba mais</button>
            </div>
          </div>
        </div>
      </header>
      <div>
        <div>
          ...
          <p className="text-lg">This is some text that stands out against the background image due to the dark overlay.</p>
        </div>
      </div>
        ...
        <div className="flex gap-6">
          ...
          <div className="bg-slate-50 rounded-lg px-8 py-8 shadow-lg " style={{ backgroundColor: "rgba(1,23,90,1)" }}>
            ...
            <ul className="text-white">
              <li className="flex ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="#dd6a6a" class="w-6 h-6">
